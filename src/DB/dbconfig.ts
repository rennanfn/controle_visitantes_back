...
export default {
  user: process.env.DB_DEV_USER_NAME_VISITANTE,
  password: process.env.DB_DEV_USER_PASSWORD_VISITANTE,
  connectString: process.env.DB_DEV_CONNECT_DESCRIPTOR_VISITANTE,
